...
calibrate_model_node = node(func=calibrate, inputs=['x_train', 'y_train', 'x_test', 'y_test', 'params:root_folder'], \
    outputs=['best_model_fraud', 'best_model_fraud_name'], tags=['calibration'])
