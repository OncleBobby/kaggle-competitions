...
train_node = node(func=train, inputs=['params:parameters', 'x_train_stock', 'y_train_stock'], outputs='model_stock', \
                  tags=['submission', 'train_predict'])
predict_node = node(func=predict, inputs=['params:parameters', 'model_stock', 'x_test_stock'], outputs='y_prediction_stock', \
                  tags=['submission', 'train_predict'])
calibrate_model_node = node(func=calibrate_model, inputs=['params:parameters', 'x_train_stock', 'y_train_stock', 'x_test_stock', 'y_test_stock'], \
        outputs='model_score', tags=['calibration', 'calibration_only'])
