...
format_x_test_node = node(func=format_x, inputs='input_test_stock', outputs='input_test_stock_formatted', tags=['preparation', 'submission'])
...
predict_node = node(func=predict, inputs=['params:parameters', 'model_stock', 'x_to_submit_stock'], outputs='y_submit_stock', tags=['submission'])
