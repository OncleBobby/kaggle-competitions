...
# kaggle_competitions documentation build
...
from kaggle_competitions import __version__ as release

# -- Project information -----------------------------------------------------

project = "kaggle_competitions"
author = "Kedro"
...
htmlhelp_basename = "kaggle_competitionsdoc"
...
latex_documents = [
    (
        master_doc,
        "kaggle_competitions.tex",
        "kaggle_competitions Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kaggle_competitions",
        "Project kaggle_competitions codebase.",
        "Data-Science",
    )
]
